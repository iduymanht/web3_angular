...
declare let infura_apikey: "<key infura>";
...
export class EthcontractService {
  ...
  constructor() {
    if (typeof window.web3 !== 'undefined') {
      ...
      this.web3Provider = new Web3.providers.HttpProvider('https://ropsten.infura.io/' + infura_apikey);
    }
  ...
  getAccountInfo() {
    return new Promise((resolve, reject) => {
      // return resolve({ fromAccount: "manh", balance:12 });
